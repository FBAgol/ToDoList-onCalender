<template>
    <div ref="landingSeite" class="landing-page">
      ...
      <div class="buttons">
        ...
        <button data-aos="fade-up-left" @click="profileContent" class="button">profil</button>
      </div>
    </div>
    <div class="auth">
      ...
      <RouterLink to="/showprofil" :class="profileIsActive ? 'show' : 'hidden'"></RouterLink>
